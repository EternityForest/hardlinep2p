...
requirements = python3,pyjnius,pynacl,six,lxml,dateutil,requests,urllib3,chardet,idna,certifi,kivy==2.0.0,kivymd,mako,plyer,android,cryptography,netifaces,beautifulsoup4,sqlite3>3.9.0,pillow,sdl2_ttf,kivy_garden.qrcode,kivy_garden.zbarcam
